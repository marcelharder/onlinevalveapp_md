...
export class VendorService {
    ...
    getProductByVendor(vendorId: number, country: string) {
        return this.http.get<DropItem[]>(
            this.baseUrl + 'vendor/valvecodes/' + vendorId + '/' + country);
    }
    getProductByVendorAndIsoCode(vendorId: number, country: string) {
        return this.http.get<DropItem[]>(
            this.baseUrl + 'vendor/valvecodesByIsoCode/' + vendorId + '/' + country);
    }

    getAllFullProducts(vendorId: number, country: string) {
        return this.http.get<TypeOfValve[]>(
